...
class UNet(nn.Module):
    def __init__(self,
        ...
        # Input conv.
        self.inc = MultiConv(in_channels, base_channels, num_convs=num_convs,batchnorm=batchnorm)
        ...
        for _ in range(num_up - 1):
            up_layers.append(Up(channels, out_channels // factor, num_convs, bilinear,batchnorm))
            channels = out_channels
            out_channels = channels // 2
